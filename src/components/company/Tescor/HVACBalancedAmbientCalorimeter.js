...
const HVACBalancedAmbientCalorimeter = (props) => {

    const dataPath = CompanyMenu.pageData[0].tescor.pageData[0].HVACBalancedAmbientCalorimeter;
...
export default HVACBalancedAmbientCalorimeter;